CLASS zcl_170422008_rest_client_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422008_rest_client_02 IMPLEMENTATION.
  ...
  METHOD user_get.
    rv_text = execute_request(
      iv_method = 'GET'
      iv_url    = gc_base_url && '/user/demo_170422008' ).
  ENDMETHOD.
  ...
  METHOD build_user_json.
    rv_json =
      '{' &&
      '"id": 61,' &&
      '"username": "demo_170422008",' &&
      '"firstName": "Muhammed",' &&
      '"lastName": "Kumkumbumcu",' &&
      '"email": "muhammedkumcumudurkine@gmail.com",' &&
      '"password": "123123",' &&
      '"phone": "5550005555",' &&
      '"userStatus": 1' &&
      '}'.
